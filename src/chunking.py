...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep the punctuation with its sentence.  The expression also accepts
        # newlines as whitespace, which makes it useful for both .txt and .md
        # documents without trying to be a full natural-language parser.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # A separator that does not occur cannot make progress; try the next
        # separator instead.
        if len(pieces) == 1:
